...
- 홈페이지링크 :https://lopelovepet.store/
- 모바일 환경은 고려되지 않은 점 양해 부탁드립니다
- 테스트 아이디 : yeontest397@gmail.com / 비밀번호: test1234
- * 현재는 도메인 주소 만료 * (2026)
_________
...
![googlecloud](https://img.shields.io/badge/Google_Cloud-4285F4?style=for-the-badge&logo=google-cloud&logoColor=white)</br>
...
[ ver 1.0.1 ]  
NestJS의 기본 body-parser 제한때문에 있었던 사진 제한을
API Gateway와 Nginx에서 요청 크기를 50MB로 늘려주어 몇몇 고화질 사진이 안올라가는 오류를 해결
